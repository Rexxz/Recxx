...
public class DatabaseDestinationMetaData {
	...
	public static class Builder {
		 ...
		 public DatabaseDestinationMetaData build() {
			 return new DatabaseDestinationMetaData(this);
		 }
	}
	
	private DatabaseDestinationMetaData(Builder builder) {
